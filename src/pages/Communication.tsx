...
const Communication = () => {
  ...
  useEffect(() => {
    if (waveformRef.current && !wavesurferRef.current) {
      ...
      wavesurferRef.current.load("/sample1.mp3");
  ...
  useEffect(() => {
    let interval;
    if (isAnalyzing && progress < 100 && isWaveformReady) {
        ...
        if (currentLine) {
          ...
          if (!speakerMap.has(speaker)) {
            speakerMap.set(speaker, {
              role: speaker,
              name: name === "Unknown" ? "Identifying..." : name, // Set null for unknown names
          ...
          if (
            ...
            speakerMap.set(speaker, {
              ...
              name: name, // Update with the known name
            });
          }
