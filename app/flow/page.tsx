...
export const metadata: Metadata = {
  title: 'RxFlow - Real-Time Options Trading Alerts & Smart Money Tracking | Institutional Grade Intelligence',
  ...
  openGraph: {
    title: 'RxFlow - Real-Time Options Trading Alerts & Smart Money Tracking',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'RxFlow - Real-Time Options Trading Alerts & Smart Money Tracking',
    }],
    locale: 'en_US',
    type: 'website',
  },
  twitter: {
    ...
    title: 'RxFlow - Real-Time Options Trading Alerts',
  ...
  alternates: {
    canonical: 'https://rxsynapse.com/flow',
  },
};
